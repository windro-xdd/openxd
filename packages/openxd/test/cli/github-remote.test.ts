...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openxd.git")).toEqual({ owner: "sst", repo: "openxd" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openxd")).toEqual({ owner: "sst", repo: "openxd" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openxd.git")).toEqual({ owner: "sst", repo: "openxd" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openxd")).toEqual({ owner: "sst", repo: "openxd" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openxd.git")).toEqual({ owner: "sst", repo: "openxd" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openxd")).toEqual({ owner: "sst", repo: "openxd" })
})
