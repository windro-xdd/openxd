...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENXD_CALLER", () => {
    process.env["OPENXD_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENXD_CALLER", () => {
    process.env["OPENXD_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENXD_CALLER", () => {
    process.env["OPENXD_CALLER"] = "unknown"
