...
export namespace ToolRegistry {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@openxd/ToolRegistry") {}
  ...
  export const layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const all = Effect.fn("ToolRegistry.all")(function* (custom: Tool.Info[]) {
        ...
        const question = ["app", "cli", "desktop"].includes(Flag.OPENXD_CLIENT) || Flag.OPENXD_ENABLE_QUESTION_TOOL
        ...
        return [
          ...
          SkillTool,
          ApplyPatchTool,
          ...(Flag.OPENXD_EXPERIMENTAL_LSP_TOOL ? [LspTool] : []),
          ...(cfg.experimental?.batch_tool === true ? [BatchTool] : []),
          ...(Flag.OPENXD_EXPERIMENTAL_PLAN_MODE && Flag.OPENXD_CLIENT === "cli" ? [PlanExitTool] : []),
          ...custom,
        ]
      })
      ...
      const tools = Effect.fn("ToolRegistry.tools")(function* (
        ...
        const filtered = allTools.filter((tool) => {
          if (tool.id === "codesearch" || tool.id === "websearch") {
            return model.providerID === ProviderID.openxd || Flag.OPENXD_ENABLE_EXA
          }
