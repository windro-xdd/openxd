...
export namespace LSP {
  ...
  const filterExperimentalServers = (servers: Record<string, LSPServer.Info>) => {
    if (Flag.OPENXD_EXPERIMENTAL_LSP_TY) {
      if (servers["pyright"]) {
        log.info("LSP server pyright is disabled because OPENXD_EXPERIMENTAL_LSP_TY is enabled")
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@openxd/LSP") {}
